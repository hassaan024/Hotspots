...
import {
  ...
  updateLikeStatus,
  addComment,
  // deletePost, // uncomment when your API supports it
  // updateCaption, // uncomment when your API supports it
} from "../components/api";
  ...
  return (
    <View style={styles.screen}>
      ...
      <Modal visible={viewerOpen} onRequestClose={closeViewer} animationType="fade" transparent>
        <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.55)", justifyContent: "center", alignItems: "center", paddingHorizontal: 10 }}>
          <TouchableOpacity onPress={closeViewer} style={{ position: "absolute", top: 32, right: 22, zIndex: 20, backgroundColor: "rgba(0,0,0,0.5)", width: 34, height: 34, borderRadius: 17, justifyContent: "center", alignItems: "center" }}>
            <Ionicons name="close" size={20} color="#fff" />
          </TouchableOpacity>

          {activePost ? (
            <View style={{ width: "100%", maxWidth: modalMaxWidth, backgroundColor: "#0B1220", borderRadius: 14, overflow: "hidden", borderWidth: 1, borderColor: "rgba(255,255,255,0.03)", maxHeight: "90%" }}>
              <ScrollView showsVerticalScrollIndicator={false}>
                {/* header */}
                <View style={{ flexDirection: "row", alignItems: "center", paddingHorizontal: 14, paddingTop: 12, paddingBottom: 8 }}>
                  <Image source={{ uri: toAbsUri(activePost.profilepic || "https://cdn-icons-png.flaticon.com/512/847/847969.png") }} style={{ width: 40, height: 40, borderRadius: 20, marginRight: 10 }} />
                  <Text style={{ color: "#E5E7EB", fontWeight: "bold", fontSize: 15, flex: 1 }}>@{activePost.postedby}</Text>
                ...
                {/* 3-dot menu */}
                {menuVisible && (
                  <View style={{ position: "absolute", top: 80, right: 25, backgroundColor: "#1F2937", borderRadius: 10, paddingVertical: 8, width: 160, borderWidth: 1, borderColor: "rgba(255,255,255,0.1)", zIndex: 50 }}>
                    <TouchableOpacity
                      style={{ paddingVertical: 10, paddingHorizontal: 14 }}
                      onPress={() => {
                        setMenuVisible(false);
                        setEditedCaption(activePost?.description || activePost?.caption || activePost?.text || "");
                        setEditModalVisible(true);
                      }}
                    >
                      <Text style={{ color: "#E5E7EB" }}>Edit Caption</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={{ paddingVertical: 10, paddingHorizontal: 14 }}
                      onPress={() => {
                    ...
                    >
                      <Text style={{ color: "#F87171" }}>Delete Post</Text>
                    </TouchableOpacity>
                  </View>
                )}
                ...
                <View style={{ backgroundColor: "#000" }}>
                  <Media uri={toAbsUri(activePost.datapath)} isVideo={isVideoPost(activePost)} poster={getPoster(activePost)} size={modalMaxWidth} />
                </View>
                ...
                <View style={{ flexDirection: "row", alignItems: "center", gap: 16, paddingHorizontal: 14, paddingTop: 10 }}>
                  ...
                  <TouchableOpacity onPress={() => setViewerCommentsOpen((v) => !v)} style={{ paddingVertical: 3 }}>
                    <Ionicons name={viewerCommentsOpen ? "chatbubble" : "chatbubble-outline"} size={24} color="#E5E7EB" />
                  </TouchableOpacity>
                ...
                <View style={{ paddingHorizontal: 14, paddingTop: 6 }}>
                  ...
                  <Text style={{ color: "#E5E7EB", marginTop: 2 }}>
                    <Text style={{ fontWeight: "bold" }}>@{activePost.postedby} </Text>
                    {String(activePost.description || activePost.caption || activePost.text || "").trim() || "(no description)"}
                  </Text>
                </View>
          ...
          <Modal visible={editModalVisible} transparent animationType="fade" onRequestClose={() => setEditModalVisible(false)}>
            <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.6)", justifyContent: "center", alignItems: "center" }}>
              <View style={{ backgroundColor: "#111827", borderRadius: 10, padding: 20, width: "85%", borderWidth: 1, borderColor: "rgba(255,255,255,0.05)" }}>
                <Text style={{ color: "#E5E7EB", fontWeight: "bold", marginBottom: 8 }}>Edit Caption</Text>
                <TextInput
                  value={editedCaption}
                ...
                <View style={{ flexDirection: "row", justifyContent: "flex-end", gap: 12 }}>
                  ...
                  >
                    <Text style={{ color: "#60A5FA", fontWeight: "bold" }}>Save</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
